...
{
    public static class ProveedorBR
    {
        ...
        // Método general para validar toda la clase Proveedor
        public static void ValidarProveedor(Proveedor proveedor)
        {
            if (proveedor == null)
            {
                throw new ArgumentNullException(nameof(proveedor), "El objeto Proveedor no puede ser nulo.");
            }

            // Validar el nombre
            ValidarNombre(proveedor.TC_Nombre);
        }
    }
}
