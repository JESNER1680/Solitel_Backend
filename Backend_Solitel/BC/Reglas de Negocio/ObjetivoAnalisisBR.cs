...
{
    public static class ObjetivoAnalisisBR
    {
        ...
        // Método general para validar toda la clase ObjetivoAnalisis
        public static void ValidarObjetivoAnalisis(ObjetivoAnalisis objetivoAnalisis)
        {
            if (objetivoAnalisis == null)
            {
                throw new ArgumentNullException(nameof(objetivoAnalisis), "El objeto ObjetivoAnalisiso no puede ser nulo.");
            }

            // Validar el nombre
            ValidarNombre(objetivoAnalisis.TC_Nombre);

            // Validar la descripción
            ValidarDescripcion(objetivoAnalisis.TC_Descripcion);
        }
    }
}
