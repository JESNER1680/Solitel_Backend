...
{
    public static class TipoAnalisisBR
    {
        ...
        // Método general para validar toda la clase TipoAnalisis
        public static void ValidarTipoAnalisis(TipoAnalisis tipoAnalisis)
        {
            if (tipoAnalisis == null)
            {
                throw new ArgumentNullException(nameof(tipoAnalisis), "El objeto TipoAnalisis no puede ser nulo.");
            }
